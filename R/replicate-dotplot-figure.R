...
df_plot %>% 
        ...
        geom_point(aes(x = change_cens), pch = 16, size = 2)+
        geom_point(aes(x = change_rolling), pch = 21, size = 2, fill = "white")+
